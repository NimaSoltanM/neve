...
const en: Translations = {
  ...
  shops: {
    ...
    liveUrlPreview: 'Live URL Preview',
  },
  upload: {
  ...
  shop: {
    ...
    auctions: {
      ...
      duplicate: 'Duplicate',
      endEarly: 'End Early',
      noBids: 'No bids received',
      endedSuccessfully: 'Auction ended successfully',
      duplicated: 'Auction duplicated successfully',
      stats: {
  ...
  cart: {
    ...
    inCart: 'In Cart',
    addedToCart: 'Added to cart!',
    checkoutNote: 'Review your items before proceeding to payment',
    clearAll: 'Clear All',
    itemCount: 'Items',
    subtotal: 'Subtotal',
  },
  ...
  shopOrders: {
    manageDescription: 'View and manage orders from your shop',
    ...
    completed: 'Completed',
    cancelled: 'Cancelled',
    pageInfo: 'Page {page} of {totalPages} ({total} total orders)',
