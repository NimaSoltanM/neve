...
const fa: Translations = {
  ...
  shop: {
    ...
    auctions: {
      title: 'حراج‌های من',
      export: 'دریافت خروجی',
      createNew: 'ایجاد حراج جدید',
      active: 'فعال',
      ended: 'پایان یافته',
      search: 'جستجوی حراج‌ها...',
      selected: 'انتخاب شده',
      endSelected: 'پایان دادن به موارد انتخابی',
      clearSelection: 'پاک کردن انتخاب',
      bids: 'پیشنهاد',
      view: 'مشاهده جزئیات',
      duplicate: 'کپی کردن',
      endEarly: 'پایان زودهنگام',
      noBids: 'هیچ پیشنهادی دریافت نشد',
      endedSuccessfully: 'حراج با موفقیت پایان یافت',
      duplicated: 'حراج با موفقیت کپی شد',
      stats: {
        active: 'حراج‌های فعال',
        awaiting: 'در انتظار پرداخت',
        paid: 'پرداخت شده',
        revenue: 'درآمد کل',
        avgBids: 'میانگین پیشنهادات',
      },
      sort: {
        newest: 'جدیدترین',
        ending: 'نزدیک به پایان',
        price: 'بالاترین قیمت',
        bids: 'بیشترین پیشنهاد',
      },
      status: {
        ended: 'پایان یافته',
        paid: 'پرداخت شده',
  ...
  cart: {
    ...
    inCart: 'در سبد خرید',
    addedToCart: 'به سبد خرید اضافه شد!',
    checkoutNote: 'قبل از پرداخت، اقلام خود را بررسی کنید',
  ...
  shopOrders: {
    manageDescription: 'مشاهده و مدیریت سفارشات فروشگاه شما',
    ...
    noOrdersYet: 'هنوز سفارشی دریافت نکرده‌اید',
    noOrdersWithFilter: 'سفارشی با این فیلتر یافت نشد',
    pending: 'در انتظار پرداخت',
    paid: 'پرداخت شده',
    completed: 'تکمیل شده',
    cancelled: 'لغو شده',
    pageInfo: 'صفحه {page} از {totalPages} ({total} سفارش)',
    updateSuccess: 'وضعیت سفارش با موفقیت به‌روزرسانی شد',
    updateError: 'خطا در به‌روزرسانی وضعیت سفارش',
  },
  analytics: {
    title: 'تحلیل و گزارش',
    overview: 'نمای کلی',
    ...
    product: 'محصول',
    unitsSold: 'تعداد فروخته شده',
    noProducts: 'هیچ محصولی در این دوره فروخته نشده',
    noData: 'داده‌ای برای این دوره موجود نیست',
    period7d: '۷ روز گذشته',
    period30d: '۳۰ روز گذشته',
    period90d: '۹۰ روز گذشته',
    period1y: 'سال گذشته',
    customRange: 'بازه سفارشی',
    demoMode: 'حالت نمایشی',
    realMode: 'داده واقعی',
    viewRawData: 'مشاهده داده خام',
    demoDataNotice: 'نمایش داده‌های آزمایشی برای پیش‌نمایش',
    selectPeriod: 'انتخاب دوره',
    demoModeTitle: 'حالت نمایشی - پیش‌نمایش تحلیل‌ها',
    realModeTitle: 'داده واقعی - تحلیل واقعی فروشگاه شما',
    demoModeDescription:
      'این یک نمایش با داده‌های نمونه واقع‌گرایانه برای نمایش قابلیت‌های تحلیلی است. برای کاوش در امکانات داشبورد قبل از داشتن فروش واقعی عالی است.',
    realModeDescription:
      'این نشان‌دهنده عملکرد واقعی فروشگاه شما بر اساس سفارشات پرداخت‌شده و تکمیل‌شده است. داده‌ها به‌صورت لحظه‌ای با خرید مشتریان به‌روز می‌شوند.',
    demoModeFeature1: 'روندهای واقع‌گرایانه درآمد و رشد',
    demoModeFeature2: 'نمونه محصولات پرفروش با تصاویر',
    demoModeFeature3: 'مقایسه دوره‌ها برای نمایش امکانات تحلیلی',
    howItWorks: 'نحوه کار',
    demoExplainer:
      'حالت نمایشی داده‌های واقع‌گرایانه برای دوره انتخاب‌شده تولید می‌کند تا به شما کمک کند بفهمید وقتی فروش دارید تحلیل‌ها چگونه خواهند بود.',
    realExplainer:
      'حالت واقعی تحلیل‌ها را فقط از سفارشات پرداخت‌شده و تکمیل‌شده شما نمایش می‌دهد. سفارشات در انتظار یا لغو شده شامل نمی‌شوند.',
  },
  preview: {
    title: 'کشف امکانات کامل',
    subtitle: 'این نمونه‌کار یک پلتفرم تجارت الکترونیک کامل است',
    dismiss: 'بستن',
    tryIt: 'امتحان کنید',
    explored: 'بازدید شده',
    buy: {
      title: 'خرید و پرداخت',
      desc: 'مرور محصولات، سبد خرید، تکمیل خرید',
    },
    vendor: {
      title: 'فروشنده شوید',
      desc: 'فروشگاه بسازید و محصول بفروشید',
    },
    auction: {
      title: 'حراج آنلاین',
      desc: 'مزایده زنده روی محصولات',
    },
    rtl: {
      title: 'فارسی/انگلیسی',
